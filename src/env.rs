...
pub enum ConfigurationKey {
    ...
    EmailAddEmailTitle,
    EmailAddEmailTemplate,
    EmailUpdateEmailTitle,
    EmailUpdateEmailTemplate,
    ApiErrorOtpExpired,
...
impl ConfigurationKey {
    fn name(&self) -> &'static str {
        match self {
            ...
            Self::StoreRateLimit => "STORE_RATE_LIMIT",
            ...
            Self::EmailAddEmailTitle => "EMAIL_ADD_EMAIL_TITLE",
            Self::EmailAddEmailTemplate => "EMAIL_ADD_EMAIL_TEMPLATE",
            Self::EmailUpdateEmailTitle => "EMAIL_UPDATE_EMAIL_TITLE",
            Self::EmailUpdateEmailTemplate => "EMAIL_UPDATE_EMAIL_TEMPLATE",
